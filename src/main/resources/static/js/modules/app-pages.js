      ...
      <div class="page">
        ...
        <template v-else>
          ...
          <div class="movie-detail-card">
            <img :src="movie.posterUrl" :alt="movie.title" loading="eager" decoding="async" fetchpriority="high" />
            <div>
              <h2>{{ movie.title }}</h2>
        ...
        <template v-else>
          ...
          <div class="seat-selection">
            ...
            <div class="selection-summary">
              <div v-if="purchaseError" class="state-message state-message-error" role="alert" aria-live="assertive">{{ purchaseError }}</div>
              <div v-if="purchaseSuccess" class="state-message state-message-success" role="status" aria-live="polite">{{ purchaseSuccess }}</div>
              <div>
                <strong>已選座位：</strong>
        ...
        <template v-else>
          <div class="movie-detail-card">
            ...
            <div>
              ...
              <div v-if="payError" class="state-message state-message-error mt-14" role="alert" aria-live="assertive">{{ payError }}</div>
              <div v-if="paySuccess" class="state-message state-message-success mt-14" role="status" aria-live="polite">{{ paySuccess }}</div>
...
const OrderDetailPage = {
    ...
    <div class="app-shell">
      <div class="page">
        ...
        <template v-else>
          ...
          <div v-if="actionError" class="state-message state-message-error mt-14" role="alert" aria-live="assertive">{{ actionError }}</div>
          <div v-if="actionSuccess" class="state-message state-message-success mt-14" role="status" aria-live="polite">{{ actionSuccess }}</div>
        </template>
      </div>
    </div>
  `,
  ...
  window.CinemaAppPages = Object.freeze({
    HomePage,
    MovieDetailPage,
    SeatSelectionPage,
    CheckoutPage,
